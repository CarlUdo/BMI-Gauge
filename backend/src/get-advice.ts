...
const obesity = `You´re struggling with obesity. Focusing on your health is commendable. Working closely with a healthcare provider can help create a sustainable plan to achieve a healthier weight. Remember to be patient with yourself, prioritize balanced nutrition and regular physical activity, and take things one step at a time. You're on the right path!`;

const severeObesity = `You´re struggling with severe obesity. Severe obesity poses significant health risks and needs urgent attention. It increases the likelihood of serious conditions like heart disease, diabetes, and hypertension. It's crucial to seek help from a healthcare professional to develop a plan that addresses these risks and improves overall health. Your well-being is a priority; take action now.`;
